...
public class line {
	public int s_group_idx = Parameters.line_start_group_idx;
	public int s_obj_idx = Parameters.line_start_obj_idx;
	public int e_group_idx = Parameters.line_end_group_idx;
	...
	public static void move(int group_idx, int obj_idx, Point new_start) {
		for(int lines_idx =0; lines_idx < canvas_panel.all_lines.size();lines_idx++) {
			if((canvas_panel.all_lines.get(lines_idx).s_group_idx == group_idx)&&
			   (canvas_panel.all_lines.get(lines_idx).s_obj_idx == obj_idx)) {
			...
			if((canvas_panel.all_lines.get(lines_idx).e_group_idx == group_idx)&&
			   (canvas_panel.all_lines.get(lines_idx).e_obj_idx == obj_idx)) {
